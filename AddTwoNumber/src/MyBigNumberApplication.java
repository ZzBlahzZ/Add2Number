...
public class MyBigNumberApplication extends javax.swing.JFrame implements IReceiver{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Plus 2 Number App");
        ...
        jLabel5.setText("Each program step");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!flag1) {
            JOptionPane.showMessageDialog(rootPane,"In String " + s1 + " It have Strange Keywords");
        }
        
        if (!flag2) {
            JOptionPane.showMessageDialog(rootPane,"In String " + s2 + " It have Strange Keywords");
        }
